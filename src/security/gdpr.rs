...
pub async fn export_data(
    ...
    let user_details: Option<(String, String, String, String, Option<String>, i64, bool, bool)> = sqlx::query_as(
    ...
    let (id, email, name, role, phone, created_at, marketing, analytics) =
